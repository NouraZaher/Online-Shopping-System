...
<?php include('include/sidenav_owner.php') ?>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
              ...
              <a class="dropdown-item text-center small text-gray-500" href="orderpage_owner.php">Show All Orders</a>
            </div>
          </li>
      ...
      <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Number Of Stores</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                <?php
                $username = $_SESSION['username'];

                $count_query = "SELECT COUNT(store_id) FROM stores WHERE stores.username = '$username' ";
                $getresults = mysqli_query($db, $count_query);
                $row = mysqli_fetch_array($getresults);

                echo $row['COUNT(store_id)'];
                ?>
              </div>
            </div>
            <div class="col-auto">
          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                ...
                $count_query = "SELECT COUNT(product_id) FROM products,stores WHERE products.store_id = stores.store_id and stores.username = '$username'";
                $getresults = mysqli_query($db, $count_query);
                $row = mysqli_fetch_array($getresults);
...
<?php include('include/storetable_owner.php') ?>
        ...
        <form class="" action="owner_server.php" method="post">
              <div class="form-group">
                  <label for="formGroupExampleInput">Store Name</label>
                    <input name="store_name" type="text" class="form-control" id="formGroupExampleInput" placeholder="Enter Store Name">
                  </div>
                  <div class="form-group">
                    <label for="formGroupExampleInput2">Store Adress</label>
                    <input name="store_address" type="text" class="form-control" id="formGroupExampleInput2" placeholder="Enter Address">
                  </div>
                  <div class="form-group">
                    <label for="formGroupExampleInput2">Phone number</label>
                    <input name="store_phonenumber" type="text" class="form-control" id="formGroupExampleInput2" placeholder="Enter Phone Number">
                  </div>
                  <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="http://localhost/OSS/index.php">Logout</a>
        </div>
      </div>
    </div>
  </div>
